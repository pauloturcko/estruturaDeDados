// Diferente da TabelaHash, o Dictionary nos permite expecificar o tipo de dado que será utilizado nos pares Key -> Value
...
if(valor is not null) Console.WriteLine($"Chave 4: {valor}");
